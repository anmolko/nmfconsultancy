            ...
            <div class="sticky-side-div">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="position-relative mb-3">
                            <label class="form-label" for="direction-heading-input">Subheading <span class="text-muted text-danger">*</span></label>
                            <input type="text" class="form-control" maxlength="20" id="action_heading2" name="action_heading2" value="{{@$homesettings->action_heading2}}"
