...
<head>
    ...
    @if (\Request::is('/'))
        <title>{{ucwords(@$setting_data->website_name ?? '')}}</title>
    @else
        <title>@yield('title') | {{ucwords(@$setting_data->website_name ?? '')}} </title>
    @endif
        ...
        <div class="container-fluid">
            <div class="main-header__inner">
                <div class="main-header__logo">
                    <a href="/">
                        <img src="{{$setting_data->logo ? asset('/images/settings/'.@$setting_data->logo):''}}" alt="{{ $setting_data->website_name ?? '' }}" width="142">
                    </a>
                ...
                <div class="main-header__nav__wrapper">
                    ...
                    <div class="main-header__right">
                        ...
                        <a href="{{ route('contact') }}" class="modins-btn main-header__btn">
                            Get a Quote
                            <em></em>
